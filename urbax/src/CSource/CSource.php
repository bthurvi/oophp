...
class CSource {
  ...
  public function View() {
    return "<div class=explorer>" .$this->GetBreadcrumbFromPath() 
      . $this->message . $this->ReadCurrentDir(). "</div>" . $this->GetFileContent();
  }
  ...
  public function GetBreadcrumbFromPath() {
    ...
    $html .= "<li><a href='?p=code'>" . basename($this->baseDir) . "</a>/</li>";
    $path = null; 
    foreach($this->breadcrumb as $val) {
      $path .= "$val/";      
