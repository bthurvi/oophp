  ...
  public static function getSearchForm($p,$page,$hits,$title,$year1,$year2, $databasehandle)
  {
    ...
    return <<< eod
     <form method="get" class='searchpanel'>
      ...
      <p><label style='display: inline-block; width:170px;'>Skapad mellan åren: </label><input type='text' name='year1' value='$year1'/></label> - <label><input type='text' name='year2' value='$year2'/></p>
