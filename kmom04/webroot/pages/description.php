...
<p>Innan jag gick vidare insåg jag att det skulle bli många sidor och meny-alternativ om jag genomförde allt som stod i genomgången. Eftersom jag mindes något om att jag läst något om en extrauppgift
i form av drop-down alternativ så gjorde jag återigen ett snabbt hopp för att titta på den delen.</p>

<p>I den <a href="http://dbwebb.se/coachen/en-navbar-med-drop-down-meny-i-ren-html-och-css">första delen</a> som jag läste handlade det bara om HTML-strukturen och CSS:en. 
